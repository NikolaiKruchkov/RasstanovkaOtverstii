...
namespace RasstanovkaOtverstii
{
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            foreach (Duct d in ducts)
            {
                ...
                foreach (ReferenceWithContext refer in intersections)
                {
                    ...
                    XYZ pintHole = point + (direction * proximity);
                    FamilyInstance hole = arDoc.Create.NewFamilyInstance(pintHole, familySymbol, wall, level, Autodesk.Revit.DB.Structure.StructuralType.NonStructural);
